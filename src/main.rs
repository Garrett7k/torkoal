...
#[group]
#[commands(card_guild, card_dm, doublecard, blackwhitelands, randomsearch_guild, randomsearch_dm)]
struct General;
...
#[aliases(scry, s)]
#[only_in(guilds)]
async fn card_guild(ctx: &Context, msg: &Message, args: Args) -> CommandResult {
...
#[aliases(sr)]
#[only_in(guilds)]
async fn randomsearch_guild(ctx: &Context, msg: &Message) -> CommandResult {
   msg_clean_up(ctx, msg).await;
...
#[command]
#[aliases(scrydm, sdm)]
async fn card_dm(ctx: &Context, msg: &Message, args: Args) -> CommandResult {
   // msg_clean_up(ctx, msg).await;
...
#[command]
#[aliases(srdm)]
async fn randomsearch_dm(ctx: &Context, msg: &Message) -> CommandResult {
   //msg_clean_up(ctx, msg).await;
